...
public class FeatureStoriesLinker {
	...
	public static void main(String[] args) {
		...
		try {
			for (String[] storyFeaturePair: storyFeaturePairs) {
				logger.info(String.format("Linking story %s to feature %s",storyFeaturePair[0], storyFeaturePair[1]));
	...
	private void link(String storyJiraID, String featureJiraID, String workspaceID, String projectID) throws IOException  {
	...
	private JsonObject getWorkItemFromJiraID(String storyJiraID, String type, String workspaceID, String projectID) throws IOException {
	...
	private String getRefFromContainerName(String containerType, String containerName) throws IOException {
